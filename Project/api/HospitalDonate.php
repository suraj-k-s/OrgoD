...
include("Connection.php");
    ...
    if($_SERVER['REQUEST_METHOD']=="POST")
    {
        ...
        $insQry = "insert into tbl_donor(donor_name,donor_details,donor_healthreport,donor_proof,blood_id,organ_id,donor_date,donor_image,donor_contact,hospital_id)
