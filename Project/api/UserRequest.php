...
include("Connection.php");
    ...
    if($_SERVER['REQUEST_METHOD']=="POST")
    {
        ...
        $insQry = "insert into tbl_receiver(receiver_name,receiver_details,receiver_healthreport,receiver_proof,blood_id,organ_id,receiver_date,receiver_image,receiver_contact,user_id)
